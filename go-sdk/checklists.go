...
// CreateChecklist creates a new checklist with a title and structured tasks.
...
// UpdateChecklist replaces the title and structured tasks of an existing checklist.
