...
// SetDefaultChecklist assigns a checklist as the default for all future bookings on this property.
// If updateUpcomingBookings is true, the checklist is also applied to all existing upcoming bookings.
func (s *PropertiesService) SetDefaultChecklist(ctx context.Context, propertyID, checklistID int, updateUpcomingBookings bool) (APIResponse[map[string]interface{}], error) {
