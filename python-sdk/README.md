...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-107%20passing-brightgreen" alt="107 passing">
...
| `cleanerStatus` | str | Cleaner operational progress, independent of `status` |
| `date` | str | `YYYY-MM-DD` |
| `time` | str | `HH:MM` |
